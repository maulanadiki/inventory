    ...
    <div class="row">
        ...
        <div class="col-md-6 ms-5 mb-2">
            <div class="col-md-12 d-flex justify-content-end mt-4">
                    <a href="{{route('barang.buat') }}" class="btn btn-primary me-3">
                ...
                <table id="example" class="table table-striped pt-3 mb-2" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="gmb('{{$br->f_barang}}')">
