                                                ...
                                                <tr>
                                                    <td colspan="5">
                                                        <?php
                                                                ...
                                                                ?>
                                                        Dibuat Sejak :
                                                        @if($perbedaanj < 1) <b>{{$perbedaanm}}</b> yang lalu
                                                            @else
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="input-group mb-3">
                    <input type="hidden" id="nomor_po" name="nopo">
                    <input type="file" class="form-control" name="gambar" accept="image/png, image/gif, image/jpeg" required>
                    <label class="input-group-text" for="inputGroupFile02" name="gambar" >Upload</label>
                </div>
            </div>
...
<script>
function modal(nopo) {
    var inputElement = document.getElementById('nomor_po');
    inputElement.value = nopo;
}
</script>
