        ...
        <div class="col-md-12">
            <div class="row d-flex justify-content-center">
                @if(auth()->user()->level == 1 || auth()->user()->level == 2 )
                            ...
                            <div class="col-md-5 col-6">
                                ...
                                <div class="col-md-4 text-center d-flex justify-content-center">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-cart mt-3" viewBox="0 0 16 16">
                                        ...
                                        <p class="card-text text-center mt-2" style="font-size:14px;"><strong>Request PO</strong></p>
                                    </div>
                                </div>
                                <div class="col-md-4 text-center d-flex justify-content-center">
                                    <div class="col-md-12 border shadow text-center"  style="border-radius:10px; background-color: #FCF8E8;">
                                    <img src="{{asset('sendiri/box_datang.png') }}" width="60px" class="img-fluid mt-2" alt="">
                                        <h2 class="card-title text-center mt-3" ><strong>{{$terima_barang}}</strong></h2>
                                ...
                                <div class="col-md-4 text-center d-flex justify-content-center">
                                    ...
                                    <img src="{{asset('sendiri/box_keluar.png') }}" width="60px" class="img-fluid mt-2" alt="">
                                        <h2 class="card-title text-center mt-3" ><strong>{{$penjualan}}</strong></h2>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 d-flex justify-content-center" style="height:100px;">
                                        ...
                                        <div class="col-md-4 text-center align-self-center border-end">
                                            ...
                                            <div class="col-md-8 text-center align-self-center">
                                            <span class="lh-sm mt-4 "><strong>Karyawan</strong> <br>{{$employe}} </span>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <a data-bs-toggle="collapse" style="text-decoration:none; font-size:2rem; font-weight:600;" class="text-dark" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                        Minimum Stok Barang
                    </a>
                    </div>
