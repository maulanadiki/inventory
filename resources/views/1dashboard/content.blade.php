    ...
    <div class="frame">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <h6>
                    Persiapkan diri, untuk melaksanakan tugas yang ada
                </h6>
            </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-12 mb-5">
                        <div class="col-md-12 border shadow text-center"
                            style="border-radius:10px; background-color: #FCF8E8;">
                            ...
                            <p class="card-text text-center mt-2" style="font-size:14px;"><strong>Barang Keluar</strong>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-5">
                        <div class="col-md-12 border shadow text-center"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                style="width:70px; height:100%; margin:10px 0 10px 0;" fill="currentColor"
                            ...
                            <p class="card-text text-center mt-2" style="font-size:14px;"><strong>Stok Barang</strong>
                            </p>
                        </div>
                    </div>
                </div>
