    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <div class="col-md-12 border border-3 rounded-3 mb-2 shadow-sm" style="height:16vh; background-color:white;">
                <div class="row">
                    <div class="col-md-6 text-center"><img src="{{asset('sendiri/box_keluar1.png') }}" width="50%" class="img-fluid mt-1" alt=""></div>
            ...
            <div class="col-md-12 border border-3 rounded-3 mt-1 shadow-sm" style="height:16vh; background-color:white;">
                <div class="row">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" style="width:50%; height:auto;" fill="currentColor" class="bi bi-card-list" viewBox="0 0 16 16">
