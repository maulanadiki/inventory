                ...
                <tr align="center" id="cariprr" onClick="nilai('{{$hsl->bukti}}')">
                                        ...
                                        @else
                                            ...
                                            @else
                                                ...
                                                <a href="{{route('penerima.terima',$hsl->nopo) }}" class="btn btn-warning" >{{$hsl->statpr}}</a>
                                                @else
                                        ...
                                        <td>
                                            ...
                                            @else
                                            <button class="btn btn-success" type="button" data-bs-toggle="modal" data-bs-target="#receipt" onclick="gmbr('{{$hsl->bukti}}')" style="cursor: pointer;">Receipt</button>
                                                @endif

                                        </td>
                                    </a>
                                </tr>
                            </form>@endforeach</tbody>
                        </table><br>
        </div>
    </div>
</div>
<!-- modalnya -->
<div class="modal fade" id="receipt" height="300" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
