        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ul class="breadcrumb ms-3">
                    ...
                    <li class="breadcrumb-item"><a class="fs-5" href="{{url('/vendors') }}">Tabel Barang</a></li>
                    <li class="breadcrumb-item fs-5 text-light">Daftar Vendor</a></li>
                </ul>
            </nav>
        </div>

        <div class="col-md-12 shadow border rounded-3">
            <div class="form-center">
                <form method="post" action="{{ url('vendors/form/save') }}" enctype="multipart/form-data">
                    ...
                    <input type="hidden" class="form-control" name="k_vendor" maxlength="7"
                        placeholder="Masukan nomor KTP" value="<?php
            echo "VNR"?> {{++$vendor}}">
                    ...
                    <div class="row " style="width: 1000px;">
                        <div class="col-md-12" align="center">
                            <h3>FORM REGISTER VENDOR</h2>
                                <hr>
                        </div>
                        <!-- NIK -->
                        <div class="col-md-5  d-flex justify-content-end align-items-center">NIK</div>
                        <div class="col-md-4"><input type="text" class="form-control is-invalid inputan" id="inik"
                                onkeypress="return event.charCode >= 48 && event.charCode <=57" name="nik"
                                maxlength="16" placeholder="Masukan NIK" required></div>

                        <!-- NPWP -->
                        <div class="col-md-5  d-flex justify-content-end align-items-center mt-2">NPWP</div>
                        <div class="col-md-4 mt-2"><input type="text" class="form-control is-invalid inputan" id="inpwp"
                                onkeypress="return event.charCode >= 48 && event.charCode <=57" name="npwp"
                                maxlength="12" placeholder="Masukan NPWP" required></div>

                        <!-- nama VENDOR-->
                        <div class="col-md-5  d-flex justify-content-end align-items-center mt-2">NAMA VENDOR</div>
                        <div class="col-md-4 mt-2"> <input type="text" class="form-control is-invalid inputan"
                                onkeypress="return event.charCode < 48 || event.charCode >57" id="ivendor"
                                name="n_vendor" maxlength="50" placeholder="Masukan Nama Vendor" required></div>
                        <!-- NAMA PEMILIK -->
                        ...
                        <div class="col-md-4 mt-2"> <input type="text" class="form-control is-invalid inputan"
                                ...
                                name="n_pemilik" maxlength="50" placeholder="Masukan Nama Vendor" required></div>

                        <!-- NOMOR TELP -->
                        <div class="col-md-5  d-flex justify-content-end align-items-center mt-2">NO TELP</div>
                        <div class="col-md-4 mt-2"><input type="text" class="form-control is-invalid inputan" id="itelp"
                                onkeypress="return event.charCode >= 48 && event.charCode <=57" name="telp"
                                maxlength="12" placeholder="Masukan telp" required></div>
                        ...
                        <div class="col-md-4 mt-2">
                            <input list="bank" class="form-select" aria-label="Default select example" id="ibank"
                                placeholder="pilih bank" name="bank" required />
                            <datalist id="bank">
                                ...
                                <option value="Bank UOB Indonesia (Dahulu Uob Buana)"> Bank UOB Indonesia (Dahulu Uob
                                    Buana)
                                </option>
                                <option value="Bank Tabungan Pensiunan Nasional"> Bank Tabungan Pensiunan Nasional, Tbk
                                </option>
                                <option value="Bank Tabungan Pensiunan Nasional (BTPN)"> Bank Tabungan Pensiunan
                                    Nasional
                                    (BTPN) </option>
                                <option value="Bank Syariah Muamalat Indonesia"> Bank Syariah Muamalat Indonesia
                                </option>
                                ...
                                <option value="Bank Jatim (dahulu bernama BPD Jawa Timur)"> Bank Jatim (dahulu bernama
                                    BPD
                                    Jawa Timur) </option>
                                <option value="Bank Jateng ( dahulu BPD Jawa Tengah )"> Bank Jateng ( dahulu BPD Jawa
                                    Tengah
                                    ) </option>
                                ...
                                <option value="Bank Internasional Indonesia (BII)"> Bank Internasional Indonesia (BII)
                                </option>
                        ...
                        <div class="col-md-4 mt-2"><input type="text" class="form-control is-invalid inputan"
                                onkeypress="return event.charCode >= 48 && event.charCode <=57" id="inorek" name="norek"
                                maxlength="12" placeholder="Nomor Rekening" required></div>
                        ...
                        <div class="col-md-4 mt-2">
                            <div class="input-group">
                                <input type="file" class="form-control" id="itext"
                                    aria-describedby="inputGroupFileAddon04" aria-label="Upload" name="f_nik"
                        ...
                        <div class="col-md-4 mt-2 mb-2">
                            <div class="input-group">
                                <input type="file" class="form-control" id="itext"
                                    aria-describedby="inputGroupFileAddon04" aria-label="Upload" name="f_npwp"
                                    accept="image/png, image/gif, image/jpeg" required>
                            </div>
                        </div>

                        <div class="col-md-5  d-flex justify-content-end align-items-center mt-2 mb-2">FOTO BUKU
                            TABUNGAN
                        </div>
                        <div class="col-md-4 mt-2 mb-2">
                            <div class="input-group">
                                <input type="file" class="form-control" id="itext"
                                    aria-describedby="inputGroupFileAddon04" aria-label="Upload" name="f_buku"
                                    accept="image/png, image/gif, image/jpeg" required>
                            </div>
                        </div>
                        <br>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary mb-3 " name="submit"><i class="fa fa-floppy-o"
